 ...
 * gets applied both to the frontend and the editor. While the css gets
 * enqueued if set in block.json, sass files must be imported separately
 * to be compiled.
 */
import "./style.scss";

/**
 * Once the DOM is fully loaded, check if the 'shadowtext' attribute
